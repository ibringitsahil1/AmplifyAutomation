...
public class TC003_VerifyUWTasksForUnderwriter extends Functions {
	...
	public void VerifyLoginThroughUnderwriterUserRole(){
		...
		login.setUserName(propertiesData.getProperty("uw.userName"));
		login.setPassword(propertiesData.getProperty("uw.pass"));
		login.clickLogin();
	...
	public void VerifyOpeningOfUWTasksForUnderwriter(){
		...
		underwriterLoanOverPage.sendLoan(propertiesData.getProperty("LoanNo"));
		...
		Log1.info("*************Ending VerifyOpeningOfUWTasksForUnderwriter Test");
		}catch(Exception e){
			System.out.println("******Exception occured =" + e);
			Assert.fail();
	...
	public void VerifyifOpenedUWTasksPopulatesInMyTasksForUnderwriter(){
		...
		underwriterTasksPage.sendLoan(propertiesData.getProperty("LoanNo"));
	...
	public void VerifyCompletionOfUWTaskForUnderwriter(){
		...
		Thread.sleep(2000);
		underwriterChecklistReviewPage.sendLoan(propertiesData.getProperty("LoanNo"));
	...
	public void VerifyifClosedUWTasksPopulatesInMyTasksForUnderwriter(){
		...
		underwriterTasksPage.sendLoanInCompletedTab(propertiesData.getProperty("LoanNo"));
